...
export class QuestionService {
  ...
  getQuestionRandom(request: any = null): Observable<any> {
    return this.http.get('question/get-radom', request);
  }
  ...
  CheckOneQuestionAnswer(request: any ): Observable<any> {
    return this.http.post('question/check-one-answer', request);
  }
