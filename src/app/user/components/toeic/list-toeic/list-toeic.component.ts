...
export class ListToeicComponent implements OnInit {
	...
	constructor(private authService: AuthService, private examToeicService: ExamToeicService, private route: ActivatedRoute, private router: Router, private ngxToastr: NgxToastrService) {
		this.authService.userCurrent.subscribe(user => {
			this.userCurrent = user;
			if (user) {
				this.userCurrent.avatarUrl = this.userCurrent.avatarUrl ? this.userCurrent.avatarUrl : 'https://img2.thuthuatphanmem.vn/uploads/2018/11/30/anh-dai-dien-anime-dep_104204759.jpg';
			}
		});
	}
	...
	// 	console.log("téttttttttttttttttttt");
